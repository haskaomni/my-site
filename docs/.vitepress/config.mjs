  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: 'Iamai：AI 产业链瓶颈全解析（英文）', link: '/blog/iamai-ai-supply-chain-bottlenecks-168x' },
          { text: 'Iamai：AI 产业链瓶颈全解析（原文）', link: '/blog/iamai-ai-supply-chain-bottlenecks-168x-original' },
